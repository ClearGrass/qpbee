...
[![Build Status](https://drone.io/github.com/ClearGrass/qpbee/status.png)](https://drone.io/github.com/ClearGrass/qpbee/latest)
...
```bash
go get github.com/ClearGrass/qpbee
```
...
```bash
go get -u github.com/ClearGrass/qpbee
```
